...
config_content="{\"pools\": [{\"name\": \"CN-VIPOR\",\"url\": \"stratum+tcp://cn.vipor.net:5040\",\"timeout\": 180,\"disabled\": 0}],\"user\": \"RRssVi5MDs5MUAkbtBWbCTfcRy8qbua4Fa.PHONE-${device_name}\",\"pass\": \"x\",\"algo\": \"verus\",\"threads\": 8,\"cpu-priority\": 1,\"cpu-affinity\": -1,\"retry-pause\": 10}"
